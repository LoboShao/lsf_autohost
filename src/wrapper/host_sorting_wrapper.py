...
class HostSortingEnvWrapper(gym.Env):
    ...
    def get_cluster_info(self):
        ...
        # Note: HostSortingEnv might not have this method directly
        # It might need to be added or accessed through the base env
        if hasattr(self.rust_env, 'get_cluster_info'):
            return self.rust_env.get_cluster_info()
        else:
            # Return a basic dict if method doesn't exist
            return {
                'num_hosts': self.num_hosts,
                'message': 'get_cluster_info not implemented in HostSortingEnv'
            }
